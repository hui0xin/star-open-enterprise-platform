...
import com.star.mybatis.generator.plugins.annotation.Annotation;
import com.star.mybatis.generator.plugins.annotation.ImportAnnotation;
import com.star.mybatis.generator.plugins.custom.CustomAbstractXmlElementGenerator;
import com.star.mybatis.generator.plugins.custom.CustomJavaMapperMethodGenerator;
...
public class BasePlugin extends PluginAdapter {
    ...
    public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        topLevelClass.addAnnotation(
            ImportAnnotation.ApiModel.getAnnotation() + "(value=\"" + topLevelClass.getType().getShortName() + "\",description=\"" + remarks
                + "\")");
        try {
            // 生成controller文件
    ...
    public boolean modelFieldGenerated(Field field, TopLevelClass topLevelClass, IntrospectedColumn introspectedColumn,
        ...
        field.addAnnotation(
            ImportAnnotation.ApiModelProperty.getAnnotation() + "(name=\"" + introspectedColumn.getJavaProperty() + "\", value=\""
    ...
    private void setBaseMapper(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        FullyQualifiedJavaType imp = new FullyQualifiedJavaType("com.star.commons.support.base.BaseMapper");
