...
public class GenerateBeanUtils {
    ...
    public static void generateControllerFile(TopLevelClass topLevelClass, IntrospectedTable introspectedTable, Properties properties)
        ...
        if (packageController != null) {
            ...
            String path = introspectedTable.getContext().getJavaModelGeneratorConfiguration().getTargetProject() + "/"
                + properties.getProperty("controller").replaceAll("\\.", "/");
    ...
    public static void generateServiceFile(TopLevelClass topLevelClass, IntrospectedTable introspectedTable, Properties properties)
        ...
        if (packageService != null) {
            ...
            String fileName = generatorFileName(fileDoName);
            String path = introspectedTable.getContext().getJavaModelGeneratorConfiguration().getTargetProject() + "/"
                + properties.getProperty("service").replaceAll("\\.", "/");
            File catalog = new File(path);
            catalog.mkdirs();
    ...
    public static void generateImplFile(TopLevelClass topLevelClass, IntrospectedTable introspectedTable, Properties properties)
        ...
        if (packageImpl != null) {
            ...
            String fileName = generatorFileName(fileDoName);
            String path = introspectedTable.getContext().getJavaModelGeneratorConfiguration().getTargetProject() + "/"
                + properties.getProperty("impl").replaceAll("\\.", "/");
            File catalog = new File(path);
            catalog.mkdirs();
    ...
    public static void generateVoFile(TopLevelClass topLevelClass, IntrospectedTable introspectedTable, Properties properties)
        ...
        if (packageVo != null) {
            ...
            String fileName = generatorFileName(fileDoName);
            String path =
                introspectedTable.getContext().getJavaModelGeneratorConfiguration().getTargetProject() + "/" + properties.getProperty("vo")
                    .replaceAll("\\.", "/");
            File catalog = new File(path);
            catalog.mkdirs();
