...
public class FilePathUtils {
     ...
     * 通过 项目名称 生成包
     * projectName 项目名称
     * 如：star-file-uoplod ----》com/star/file/uoplod/
     */
     ...
     * 通过 项目名称 生成 包名
     * projectName 项目名称
     * 如：star-file-upload ----》star.file.upload
     */
     ...
     * 通过 项目名称 生成 包名
     * projectName 项目名称
     * 如：star-file-upload ----》file-upload-server
     */
     ...
     * 通过 项目名称 生成 包名
     * projectName 项目名称
     * 如：star-file-upload ----》file-upload
     */
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(getPackPath("star-file-uoplod"));
        System.out.println(getClassName("star-file-uoplod"));
        System.out.println(getClassNameFirst("star-file-uoplod"));
        System.out.println(getServerId("star-file-uoplod"));
    }
}
