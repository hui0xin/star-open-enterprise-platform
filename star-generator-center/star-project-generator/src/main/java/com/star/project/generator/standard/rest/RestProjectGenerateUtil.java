...
public class RestProjectGenerateUtil {
    ...
    public static void generateRestProject(String filePath, String projectName, String projectDesc, Boolean isDockerProject, String isYaml)
        throws Exception {
