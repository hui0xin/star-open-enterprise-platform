...
public class FontUtil {
    ...
    private static String[] fontNameArr = new String[]{"Arial", "Arial Black", "Arial Narrow", "Verdana", "Georgia", "Times New Roman",
        "Trebuchet MS", "Courier New", "Impact", "Comic Sans MS", "Tahoma", "Courier", "Lucida Sans Unicode", "Lucida Console", "Garamond",
        "MS Sans Serif", "MS Serif", "Palatino Linotype", "Symbol", "Bookman Old Style"};
