...
/**
 * Twitter_Snowflake(https://github.com/twitter/snowflake)<br>
 ...
 * 由我们程序来指定的（如下下面程序IdWorker类的startTime属性）。<br>
...
public class SnowflakeIdWorker {
     ...
     * 开始时间截 (20157-12-06)
     */
    private final long twepoch = 1512489600000L;
    ...
    public SnowflakeIdWorker(final long workerId, final long dataCenterId) {
        ...
        if (dataCenterId > this.maxDatacenterId || dataCenterId < 0) {
            throw new IllegalArgumentException(
                String.format("data center Id can't be greater than %d or less than 0", this.maxDatacenterId)
            );
        }
