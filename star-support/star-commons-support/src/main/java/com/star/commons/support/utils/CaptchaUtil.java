package com.star.commons.support.utils;
...
public class CaptchaUtil {
    ...
    public static BufferedImage createHard(int width, int height, String captchaValue, Font font, int fallHead, int splitSize) {
        ...
        if (log.isDebugEnabled()) {
            log.debug(
                "createHard(int width, int height, String captchaValue, Font font, int fallHead, int splitSize) width=" + width + " height="
                    + height + " captchaValue=" + captchaValue + " font=" + font + " fallHead=" + fallHead + " splitSize=" + splitSize);
        }
    ...
    public static BufferedImage createWeak(int width, int height, String captchaValue) {
        if (log.isDebugEnabled()) {
            log.debug("createWeak(int width, int height, String captchaValue) width=" + width + " height=" + height + " captchaValue="
                + captchaValue);
        }
