...
public class DateUtil {
    ...
    public static String formatToShort() {
    ...
    public static Date parseFromLongCompact(String date) throws ParseException {
    ...
    public static Date parseFromShortCompact(String date) throws ParseException {
